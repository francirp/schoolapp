...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { adult_id: @reward.adult_id, kid_id: @reward.kid_id, name: @reward.name, points_to_redeem: @reward.points_to_redeem }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { adult_id: @reward.adult_id, kid_id: @reward.kid_id, name: @reward.name, points_to_redeem: @reward.points_to_redeem }
    assert_redirected_to reward_path(assigns(:reward))
  end
